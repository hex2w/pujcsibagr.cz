...
<template>
    <section id="domu" class="min-h-screen pt-20 lg:pt-0">
        <Transition
            ...
            appear
        >
            <div class="flex flex-col lg:flex-row lg:gap-6 min-h-screen">
                <div class="lg:w-1/2 lg:my-auto">
                    <h2 class="text-3xl md:text-4xl font-semibold p-5 lg:pl-12">
                        Bolí tě ruce a záda?
                    </h2>
                    <div class="inline-flex gap-4">
                        <h2
                            class="text-3xl md:text-4xl p-5 lg:pl-12 text-right lg:text-left text-cyan-700 font-semibold"
                        >
                            BAGRUJ S KOČKOU!
                        </h2>
                        <img
                    ...
                    <p class="text-lg md:text-xl p-5 lg:pl-12">
                        BOBCAT&nbsp;E19 – (2t). Ve své kategorii nejsilnější
                        minirypadlo s verzí Long Arm. Stroj je ideální na
                        veškeré zemní a výkopové práce.
                    </p>
                    <a
                        target="_blank"
                        href="/specifikace.pdf"
                        class="flex text-cyan-500 underline hover:no-underline px-5 lg:pl-12"
                    >
                        <span class="transition-all hover:scale-110"
                            >Specifikace stroje</span
                        >
                    </a>
                </div>
                <img
                    class="lg:w-1/2 pt-10 lg:pt-16 md:my-10 md:mx-12 lg:my-auto lg:rounded-lg object-cover object-center"
                    :src="landingUrl"
                    alt="Bagr"
                />
                ...
                <div class="w-full absolute bottom-0 hidden md:flex">
                    <a
                        href="/#bobcat-e19"
                        class="transition-all hover:scale-125 hover:bg-cyan-500 mx-auto p-2 rounded-full bg-cyan-400 mb-5"
                    >
                        <svg
    ...
    -->
            ...
            <div id="bobcat-e19" class="bg-gray-800 text-white py-24 lg:py-34">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="flex">
                        <div class="mx-auto inline-flex gap-4">
                            <h2
                                class="my-auto text-3xl lg:text-4xl font-semibold leading-8 text-cyan-400 sm:text-center"
                            >
                                BOBCAT&nbsp;E19
                            </h2>
                            <img
                    ...
                    <div class="mt-20 max-w-lg sm:mx-auto md:max-w-none">
                        ...
                        >
                            ...
                            >
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-500 text-white sm:shrink-0"
                                >
                                    <svg
                                        class="h-8 w-8"
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <p
                                    class="mt-2 sm:min-w-0 sm:flex-1 text-lg leading-8"
                                >
                                    Stroj je citlivý a nabízí tudíž možnost
                                    jemného lazení detailů.
                                </p>
                            </div>
                            <div
                                class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row"
                ...
                <div class="sm:text-center pt-20 px-5">
                    <p
                        class="mt-2 text-3xl font-bold tracking-tight sm:text-4xl"
                    >
                        Nízká spotřeba a spolehlivost zánovního stroje s
                        ...
                        >
                            ...
                            >
                                ...
                                <p
                                    class="mt-2 sm:min-w-0 sm:flex-1 text-lg leading-8"
                                >
                                    Další výhodou je volitelná rychlost pojezdu
                                    želva, zajíc.
                                </p>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <p
                                    class="my-auto sm:min-w-0 sm:flex-1 text-lg leading-8"
                                >
                                    Dobré osvětlení umožňuje provádět činnosti i
                                    za snížených světelných podmínek.
                                </p>
                            </div>
                            <div
                                class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row"
                            >
                                ...
                                <p
                                    class="my-auto sm:min-w-0 sm:flex-1 text-lg leading-8"
                                >
                                    Pracovní podmínky zpříjemní možnost topení v
                                    kabině.
                                </p>
                            </div>
                        </div>
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="flex">
                        <div class="mx-auto inline-flex gap-4">
                            <h2
                                class="mt-16 my-auto text-3xl lg:text-4xl font-semibold leading-8 text-cyan-400 sm:text-center"
                            >
                                DUMPER
                            </h2>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <p
                                    class="mt-2 sm:min-w-0 sm:flex-1 text-lg leading-8"
                                >
                                    Hydraulicky vyklápěná korba a nakládací lžíce.
                                </p>
                            </div>
                            <div
                                class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row"
                            ...
                            >
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-500 text-white sm:shrink-0"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512"><path fill="#ffffff" d="M235.344 31.188c-35.92.543-70.472 6.628-102.97 18l5.72 17.468c30.61-10.843 63.185-16.653 97.187-17.156l.064-18.313zm18.687.187l-.06 18.375c46.9 1.963 96.236 13.842 146.56 36.47l9.376-16.25C356.84 45.9 304.253 33.282 254.03 31.374zm-139.093 24.5c-20.133 8.42-39.376 18.953-57.562 31.5l8.813 16.53c17.207-12.117 35.41-22.284 54.468-30.436l-5.72-17.595zm312.97 20.25l-61.5 106.53l55.124 31.814l61.5-106.532l-55.124-31.813zm-174.063 6.313l-.03 18.406c39.736 1.29 80.36 11.3 120.342 31.062l9.375-16.22c-42.846-21.33-86.708-32.012-129.686-33.25zm-18.688.062c-29.644 1.034-58.722 6.555-86.625 16.156l5.72 17.53c26.066-9.063 53.198-14.28 80.875-15.28l.03-18.406zM42.126 98.53a335.26 335.26 0 0 0-23.876 20.5l9.97 16.345a322.214 322.214 0 0 1 22.874-20.125l-8.938-16.72h-.03zm88.905 6.72c-17.292 7.142-34.04 15.886-50.124 26.125l8.813 16.5c15.13-9.78 30.847-18.16 47.06-25l-5.75-17.625zm122.626 35.28l-.062 18.44c30.17 1.18 61.405 7.815 93.156 20.405l9.438-16.344c-34.7-14.046-69.15-21.353-102.532-22.5zm-18.687.032c-23.744.82-46.85 4.73-69 11.563l5.718 17.5c20.297-6.28 41.433-9.915 63.218-10.688l.063-18.375zm-169.626 1.375a349.067 349.067 0 0 0-22.406 17.5l9.874 16.157a337.1 337.1 0 0 1 21.407-17.063l-8.876-16.593zm82.97 16.344c-14.515 5.62-28.545 12.503-42.033 20.595l8.782 16.406c12.534-7.633 25.55-14.124 39-19.436l-5.75-17.563zM90.53 189.03a295.09 295.09 0 0 0-20.155 15.314l9.844 16.125a282.991 282.991 0 0 1 19.155-14.876L90.53 189.03zm279.19 17.126L292.28 340.25a135.268 135.268 0 0 1 31.94 13.563l75.31-130.47l-29.81-17.187zm-114.033 147.78c-60.607.002-110.206 45.816-116.406 104.752h82.126a35.826 35.826 0 0 1-3.437-15.344c0-19.872 16.315-36.156 36.186-36.156c19.872 0 36.188 16.284 36.188 36.156c0 5.475-1.23 10.674-3.438 15.344h85.188c-6.2-58.936-55.8-104.75-116.406-104.75zm-1.53 71.94c-9.773 0-17.5 7.696-17.5 17.468c0 6.678 3.626 12.39 9.03 15.344h16.938c5.404-2.955 9.03-8.666 9.03-15.344c0-9.772-7.727-17.47-17.5-17.47zm-153.47 51.5v15.687h303.344v-15.688H100.69z"/></svg>
                                </div>
                                <p
                                    class="my-auto sm:min-w-0 sm:flex-1 text-lg leading-8"
                                >
                                    6 rychlostních stupňů + zpátečka + stupátko pro obsluhu.
                                </p>
                            </div>
                            <div
                                class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row"
                            >
                                ...
                                <p
                                    class="my-auto sm:min-w-0 sm:flex-1 text-lg leading-8"
                                >
                                    Šíře 70cm umožní jízdu ve stísněném prostoru.
                                </p>
                            </div>
                            <div
                                class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row"
                ...
                <div class="sm:text-center pt-10 px-5">
                    <p
                        class="mx-auto mt-6 max-w-2xl text-xl leading-8 text-slate-200"
                    >
                        <a href="#instruktaz" class="underline hover:no-underline">Nezkušené uchazeče zaškolíme.</a>
                    </p>
                </div>
            </div>
        </div>
